...
# uri = 'radio://0/41/2M/E7E7E7E7E7' # <-- Drone 2
# uri = 'radio://0/19/2M/E7E7E7E7E7' # <-- Drone 3
...
if __name__ == '__main__':
    ...
    client.move(0., 0., 0.5, 0., 2.0)

    # client.move_smooth([0., 0., 0.5], [2., 0., 0.5], 0., 10.)

    # client.move_smooth([0., 0., 0.5], [0.5, 0., 0.5], 0., 3.)
    # client.move_smooth([0.5, 0., 0.5], [0.5, 0.5, 0.5], 0., 3.)
    # client.move_smooth([0.5, 0.5, 0.5], [0., 0.5, 0.5], 0., 3.)
    # client.move_smooth([0., 0.5, 0.5], [0., 0., 0.5], 0., 3.)

    # client.move(0.5, 0., 0.5, 0., 3.0)
    # client.move(0.5, 0.5, 0.5, 0., 3.0)
    # client.move(0., 0.5, 0.5, 0., 3.0)
    # client.move(0., 0., 0.5, 0., 3.0)

    # move
    # client.move_smooth([0., 0., 0.3], [1., 0., 0.3], 0., 10.)
