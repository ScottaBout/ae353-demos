...
if __name__ == '__main__':
    ...
    client.move(0., 0., height, 0., 2.0)

    # Move in a square
    client.move(square_size, 0., height, 0., 3.0)
    client.move(square_size, square_size, height, 0., 3.0)
    client.move(0., square_size, height, 0., 3.0)
    client.move(0., 0., height, 0., 3.0)
